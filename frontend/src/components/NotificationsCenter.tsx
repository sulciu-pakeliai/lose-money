        ...
        <section className="page-swap page-from-right w-full max-w-4xl rounded-3xl border border-white/10 bg-white/5 p-6">
            <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        <h2 className="font-display text-3xl text-white">Notifications</h2>
                    </div>
                ...
                {notifications.length === 0 ? (
                    <div className="rounded-3xl border border-dashed border-white/10 bg-black/10 px-6 py-12 text-center">
                        <p className="text-xs uppercase tracking-[0.3em] text-slate-400/70">Empty</p>
                    </div>
                ) : (
                                ...
                                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                    <div>
                                        <div className="flex flex-wrap items-center gap-2">
                                            <span className="rounded-full border border-cyan-300/30 bg-cyan-300/12 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.24em] text-cyan-100">
                                                Notification
                                            </span>
