...
export function RouletteGame({ balance, onSpin, onOpenRules, onOutcomeReveal }: RouletteGameProps) {
    ...
    return (
        <section className="page-swap page-from-right w-full max-w-5xl rounded-4xl border border-fuchsia-300/20 bg-[radial-gradient(circle_at_top,_rgba(190,18,60,0.18),_rgba(15,23,42,0.96)_48%,_rgba(8,15,33,0.98)_100%)] p-6 shadow-[0_40px_120px_rgba(2,6,23,0.45)]">
